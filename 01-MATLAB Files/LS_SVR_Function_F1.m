...
y_orig = 0.5*sin(2*x) + 0.8*cos(4*x) + 0.05*exp(x/30);
...
y_train=0.5*sin(2*xs)+0.8*cos(4*xs)+0.05*exp(xs/30)+0.3*randn(xs_lenght,1);
...
legend('Original f_{1} Function', 'Noisy Samples', 'Approximated f_{1} Function');
